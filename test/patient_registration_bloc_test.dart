...
void main() {
  ...
  test(
    'initial state should contain auto-generated UHID starting with CCH25-',
    () {
  ...
  test(
    ...
    () async {
      ...
      expect(bloc.state.place, 'MG Road');
      expect(
        bloc.state.pincodeFetchedAddress,
  ...
  test(
    'SubmitFormEvent should register patient and send to MRD when all fields are valid',
    () async {
      // 1. Fill fields
      bloc.add(
        const UpdateFormFieldsEvent(
