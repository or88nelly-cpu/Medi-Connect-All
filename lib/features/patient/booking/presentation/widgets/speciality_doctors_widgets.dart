...
class SpecialityHeaderBanner extends StatelessWidget {
  final SpecialityEntity speciality;
  const SpecialityHeaderBanner({super.key, required this.speciality});
...
class SpecialityStatsRow extends StatelessWidget {
  final int docCount;
  const SpecialityStatsRow({super.key, required this.docCount});
...
class SpecialityShortcutsRow extends StatelessWidget {
  const SpecialityShortcutsRow({super.key});
...
class SpecialityDoctorsSection extends StatelessWidget {
  final SpecialityEntity speciality;
  final SpecialityBookingState state;

  const SpecialityDoctorsSection({
    super.key,
...
class SpecialityServicesSection extends StatelessWidget {
  final String specialityName;
  const SpecialityServicesSection({super.key, required this.specialityName});
  ...
  Widget build(BuildContext context) {
    ...
    final cardBg = isDark ? AppColors.terminalDarkCard : AppColors.surface;
    final textColor = isDark ? AppColors.surface : AppColors.terminalLightText;
    final services = _getServices(specialityName);
...
class SpecialityAboutSection extends StatelessWidget {
  final SpecialityEntity speciality;
  const SpecialityAboutSection({super.key, required this.speciality});
...
class SpecialitySupportCard extends StatelessWidget {
  const SpecialitySupportCard({super.key});
