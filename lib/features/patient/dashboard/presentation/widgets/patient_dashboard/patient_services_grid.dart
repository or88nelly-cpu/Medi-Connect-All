...
import 'package:medi_connect/features/patient/dashboard/presentation/widgets/patient_dashboard/patient_service_item.dart';
...
import 'package:medi_connect/features/patient/find_doctor/presentation/pages/find_doctor_page.dart';
import 'package:medi_connect/features/patient/health/presentation/pages/health_page.dart';
import 'package:medi_connect/features/patient/prescriptions/presentation/pages/prescriptions_page.dart';
import 'package:medi_connect/features/patient/shared/placeholder_page.dart';
...
class PatientServicesGrid extends StatelessWidget {
  ...
  List<PatientServiceItem> _buildServices(BuildContext context) {
    return [
      // 1. Book Appointment â†’ full 5-step booking flow
      PatientServiceItem(
      ...
      // 2. Find Doctors â†’ specialty grid â†’ doctor list
      PatientServiceItem(
      ...
      // 3. Health Records â†’ placeholder (records tab already in dashboard)
      PatientServiceItem(
      ...
      // 4. Prescriptions â†’ previous consultations list
      PatientServiceItem(
      ...
      // 6. Billing & Payments â†’ placeholder
      PatientServiceItem(
      ...
      // 7. Video Consultation â†’ placeholder
      PatientServiceItem(
      ...
      // 9. Health Tracker â†’ BMI + vitals page
      PatientServiceItem(
      ...
      // 11. Offers & Packages â†’ placeholder
      PatientServiceItem(
      ...
      // 12. 24/7 Support â†’ placeholder (or navigate to chat tab)
      PatientServiceItem(
