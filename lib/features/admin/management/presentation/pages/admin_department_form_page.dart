...
class AdminDepartmentFormPage extends StatefulWidget {
  ...
  @override
  State<AdminDepartmentFormPage> createState() => _AdminDepartmentFormPageState();
}
...
class _AdminDepartmentFormPageState extends State<AdminDepartmentFormPage> {
  ...
  void initState() {
    ...
    if (widget.departmentId != null) {
      // Load department details here
      // For now, mockup data
      _nameController.text = "Mock Department ${widget.departmentId}";
            ...
            Container(
              ...
              child: Form(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text("Department Name", style: AppTextStyles.labelLarge),
                    SizedBox(height: 8.h),
                    TextFormField(
