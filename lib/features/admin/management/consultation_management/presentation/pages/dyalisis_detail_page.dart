...
class DyalisisDetailPage extends StatefulWidget {
  const DyalisisDetailPage({super.key});

  @override
  State<DyalisisDetailPage> createState() => _DyalisisDetailPageState();
}

class _DyalisisDetailPageState extends State<DyalisisDetailPage> {
  @override
      ...
      child: CustomScaffold(
        ...
        body: BlocBuilder<DyalisisBloc, DyalisisState>(
          builder: (context, state) {
            ...
            } else if (state is DyalisisLoaded) {
