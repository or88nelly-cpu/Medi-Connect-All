...
class NursingDetailPage extends StatefulWidget {
  const NursingDetailPage({super.key});

  @override
  State<NursingDetailPage> createState() => _NursingDetailPageState();
}

class _NursingDetailPageState extends State<NursingDetailPage> {
  @override
