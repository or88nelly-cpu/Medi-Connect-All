...
class IcuDetailPage extends StatefulWidget {
  const IcuDetailPage({super.key});

  @override
  State<IcuDetailPage> createState() => _IcuDetailPageState();
}

class _IcuDetailPageState extends State<IcuDetailPage> {
  @override
