...
class WardDetailPage extends StatefulWidget {
  const WardDetailPage({super.key});

  @override
  State<WardDetailPage> createState() => _WardDetailPageState();
}

class _WardDetailPageState extends State<WardDetailPage> {
  @override
