...
class GeneralStoreDetailPage extends StatefulWidget {
  const GeneralStoreDetailPage({super.key});

  @override
  State<GeneralStoreDetailPage> createState() => _GeneralStoreDetailPageState();
}

class _GeneralStoreDetailPageState extends State<GeneralStoreDetailPage> {
  @override
