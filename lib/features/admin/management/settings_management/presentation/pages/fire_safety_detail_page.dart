...
class FireSafetyDetailPage extends StatefulWidget {
  const FireSafetyDetailPage({super.key});

  @override
  State<FireSafetyDetailPage> createState() => _FireSafetyDetailPageState();
}

class _FireSafetyDetailPageState extends State<FireSafetyDetailPage> {
  @override
