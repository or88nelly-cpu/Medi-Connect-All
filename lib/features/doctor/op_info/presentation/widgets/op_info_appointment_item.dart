...
import 'package:medi_connect/features/doctor/op_info/presentation/widgets/op_info_status_badge.dart';
...
class OpInfoAppointmentItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bool isBlocked =
        ...
        procedure.patientName == 'System Blocked';
        ...
        child: Row(
          children: [
            Container(
              ...
              child: Icon(Icons.block, color: AppColors.error, size: 18.r),
            ),
            SizedBox(width: 10.w),
