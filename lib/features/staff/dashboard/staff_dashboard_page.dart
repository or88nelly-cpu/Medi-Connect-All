        ...
        children: [
          ...
          Column(
            children: [
              ...
              // Welcome content + hospital image + date card
              Padding(
                padding: EdgeInsets.symmetric(horizontal: 16.w),
                child: Row(
...
class _DateCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: isDark ? const Color(0xFF0F1E3A) : AppColors.surface,
...
class _HeartbeatPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(Offset(w * 0.45, mid), 3, heartPaint);
  }
          ...
          children: [
            ...
            Stack(
              ...
              children: [
                Container(
                  ...
                  child: Icon(icon, color: AppColors.surface, size: 26.r),
                ),
            ...
            Text(
              ...
              style: TextStyle(
                fontSize: 15.sp,
                fontWeight: FontWeight.bold,
                color: isDark ? AppColors.surface : accentColor,
              ),
            ),
            SizedBox(height: 4.h),
            // Subtitle
...
class _SettingsDashCard extends StatelessWidget {
  final AuthState state;
  const _SettingsDashCard({required this.state});
