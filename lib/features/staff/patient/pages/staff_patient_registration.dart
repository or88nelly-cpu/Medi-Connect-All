...
import 'package:medi_connect/features/staff/patient/widgets/registration_bottom_bar.dart';
import 'package:medi_connect/features/staff/patient/widgets/registration_progress_header.dart';
import 'package:medi_connect/features/staff/patient/widgets/basic_info_step.dart';
...
///
/// Works in two modes:
///  - **Staff mode** â€” staff registers a new walk-in patient.
///  - **Patient mode** â€” authenticated patient completes their own profile.
///
...
class _StaffPatientRegistrationState extends State<StaffPatientRegistration> {
  // â”€â”€ Form keys for in-widget validation before advancing â”€â”€â”€â”€â”€â”€
  final _step1FormKey = GlobalKey<FormState>();
  final _step2FormKey = GlobalKey<FormState>();

  // â”€â”€ Text controllers (owned here; synced to BLoC on change) â”€â”€
  ...
  void _initPatientModeIfNeeded() {
    ...
    // firstName / lastName are required non-nullable in the new model.
    ...
    _dobCtrl.text = user.dob != null
        ? user.dob!.toIso8601String().split('T').first
        : '';
    _placeCtrl.text = ''; // address not in new model

    // These fields no longer exist in the new UserModel â€” use empty defaults.
    _wardCtrl.text = '';
    _policyIdCtrl.text = '';
    _validTillCtrl.text = '';
    _allergiesCtrl.text = '';
  ...
  // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  // NEXT BUTTON HANDLER â€” validates current step then advances
  // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  // STEP BODY â€” each step widget is stateless & BLoC-connected
  // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
