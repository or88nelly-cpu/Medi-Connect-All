...
class _HumanResourceDetailPageState extends State<HumanResourceDetailPage> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => GetIt.I<HumanResourceBloc>()..add(LoadHumanResourceStats()),
      child: CustomScaffold(
        customAppbar: const CommonAppBar(title: "Human Resource Department"),
        body: BlocBuilder<HumanResourceBloc, HumanResourceState>(
          builder: (context, state) {
            if (state is HumanResourceLoading) {
              return const Center(child: CircularProgressIndicator());
            } else if (state is HumanResourceError) {
              return Center(
                child: Text(
                  state.message,
            ...
            } else if (state is HumanResourceLoaded) {
