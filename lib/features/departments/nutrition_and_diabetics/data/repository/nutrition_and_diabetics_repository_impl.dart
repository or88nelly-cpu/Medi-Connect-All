...
class NutritionAndDiabeticsRepositoryImpl implements NutritionAndDiabeticsRepository {
  final NutritionAndDiabeticsRemoteDataSource _remoteDataSource;
  NutritionAndDiabeticsRepositoryImpl(this._remoteDataSource);

  @override
  Future<Either<Failure, Map<String, dynamic>>> getNutritionAndDiabeticsStats() async {
    try {
