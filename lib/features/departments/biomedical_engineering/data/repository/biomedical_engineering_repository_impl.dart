...
class BiomedicalEngineeringRepositoryImpl implements BiomedicalEngineeringRepository {
  final BiomedicalEngineeringRemoteDataSource _remoteDataSource;
  BiomedicalEngineeringRepositoryImpl(this._remoteDataSource);

  @override
  Future<Either<Failure, Map<String, dynamic>>> getBiomedicalEngineeringStats() async {
    try {
