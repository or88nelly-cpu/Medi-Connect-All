...
class BiomedicalEngineeringDetailPage extends StatefulWidget {
  ...
  @override
  State<BiomedicalEngineeringDetailPage> createState() => _BiomedicalEngineeringDetailPageState();
}

class _BiomedicalEngineeringDetailPageState extends State<BiomedicalEngineeringDetailPage> {
  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => GetIt.I<BiomedicalEngineeringBloc>()..add(LoadBiomedicalEngineeringStats()),
      child: CustomScaffold(
        customAppbar: const CommonAppBar(title: "Biomedical Engineering Department"),
        body: BlocBuilder<BiomedicalEngineeringBloc, BiomedicalEngineeringState>(
