...
class InformationTechnologyRepositoryImpl implements InformationTechnologyRepository {
  final InformationTechnologyRemoteDataSource _remoteDataSource;
  InformationTechnologyRepositoryImpl(this._remoteDataSource);

  @override
  Future<Either<Failure, Map<String, dynamic>>> getInformationTechnologyStats() async {
    try {
