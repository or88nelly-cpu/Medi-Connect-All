...
import 'package:medi_connect/features/common/dashboard/presentation/widgets/staff/attendance_proximity_dialog.dart';
...
class _SettingsDashCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () => context.push(RouteNames.staffSettings),
      child: Container(
