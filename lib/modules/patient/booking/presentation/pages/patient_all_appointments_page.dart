...
class PatientAllAppointmentsPage extends StatefulWidget {
  ...
  @override
  State<PatientAllAppointmentsPage> createState() => _PatientAllAppointmentsPageState();
}

class _PatientAllAppointmentsPageState extends State<PatientAllAppointmentsPage> {
  final ValueNotifier<String> _searchQueryNotifier = ValueNotifier<String>('');
  final ValueNotifier<String> _activeFilterNotifier = ValueNotifier<String>('All');
              ...
              children: [
                ...
                ValueListenableBuilder<String>(
                  ...
                  builder: (context, activeFilter, _) {
                    final filters = const ['All', 'Upcoming', 'Pending', 'Completed', 'Cancelled'];
                      ...
                      return ValueListenableBuilder2<String, String>(
                        ...
                        builder: (context, query, filter, _) {
                          ...
                          var filteredList = appointments.where((apt) {
                            // Search match
                            final matchQuery = apt.doctorName.toLowerCase().contains(query.toLowerCase()) ||
                                apt.specialty.toLowerCase().contains(query.toLowerCase());
                            ...
                            if (filter == 'Upcoming') {
                              return (displayStatus.toLowerCase() == 'confirmed' || displayStatus.toLowerCase() == 'pending') && !isPast;
                            }
                            return displayStatus.toLowerCase() == filter.toLowerCase();
                          }).toList();
                            ...
                            itemBuilder: (context, idx) {
                              ...
                              return GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    children: [
                                      DoctorImageWidget(doctorId: apt.doctorId, size: 44.r),
                                      SizedBox(width: 12.w),
                                      Expanded(
                                        child: Column(
