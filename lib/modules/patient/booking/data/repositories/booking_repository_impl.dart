...
class BookingRepositoryImpl implements BookingRepository {
  ...
  @override
  Future<List<DoctorBookingInfo>> getDoctorsBySpecialty(String specialityId, String specialityName) async {
    final list = await _remoteDataSource.getDoctorsBySpecialty(specialityId, specialityName);
  ...
  Future<List<String>> getBookedSlots(String doctorId, String dateStr) async {
    final list = await _remoteDataSource.getBookedAppointments(doctorId, dateStr);
    return list
