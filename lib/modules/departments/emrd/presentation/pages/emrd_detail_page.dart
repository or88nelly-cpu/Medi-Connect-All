...
import 'package:medi_connect/modules/departments/emrd/presentation/widgets/emrd_dashboard_widgets.dart';
...
class _EmrdDetailPageState extends State<EmrdDetailPage> {
  bool _showRecordManagementList = false;
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      ...
      child: CustomScaffold(
        customAppbar: _showRecordManagementList 
            ? CommonAppBar(
                ...
                leading: IconButton(
                  ...
                  onPressed: () {
                    setState(() {
                      _showRecordManagementList = false;
                    });
                  },
                ),
              )
                              ...
                              GridView.count(
                                ...
                                children: [
                                  ...
                                  EmrdOperationCard(
                                    ...
                                    onTap: () {
                                      setState(() {
                                        _showRecordManagementList = true;
                                      });
                                    },
                                  ),
                                  EmrdOperationCard(
