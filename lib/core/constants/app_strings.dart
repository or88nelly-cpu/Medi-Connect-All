...
class AppStrings {
  ...
  static const serverError =
      "Server unavailable. We are experiencing technical difficulties.";
  static const unauthorizedError =
      "Unauthorized access or session expired. Please login again.";
  static const notFoundError =
      "Data not found. The requested resource does not exist.";
  static const timeoutError = "Request timed out. Please try again.";
  static const maintenanceError =
      "System is currently under maintenance. We will be back shortly.";
