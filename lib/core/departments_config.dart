...
import 'package:medi_connect/modules/departments/biomedical_engineering/data/datasource/biomedical_engineering_remote_datasource.dart';
import 'package:medi_connect/modules/departments/biomedical_engineering/domain/repositories/biomedical_engineering_repository.dart';
import 'package:medi_connect/modules/departments/biomedical_engineering/data/repository/biomedical_engineering_repository_impl.dart';
...
import 'package:medi_connect/modules/departments/biomedical_engineering/presentation/bloc/biomedical_engineering_bloc.dart';
import 'package:medi_connect/modules/departments/casuality/data/datasource/casuality_remote_datasource.dart';
import 'package:medi_connect/modules/departments/casuality/domain/repositories/casuality_repository.dart';
import 'package:medi_connect/modules/departments/casuality/data/repository/casuality_repository_impl.dart';
import 'package:medi_connect/modules/departments/casuality/domain/usecases/get_casuality_stats_usecase.dart';
import 'package:medi_connect/modules/departments/casuality/presentation/bloc/casuality_bloc.dart';
import 'package:medi_connect/modules/departments/cssd/data/datasource/cssd_remote_datasource.dart';
import 'package:medi_connect/modules/departments/cssd/domain/repositories/cssd_repository.dart';
import 'package:medi_connect/modules/departments/cssd/data/repository/cssd_repository_impl.dart';
import 'package:medi_connect/modules/departments/cssd/domain/usecases/get_cssd_stats_usecase.dart';
...
import 'package:medi_connect/modules/departments/customer_care/data/repository/customer_care_repository_impl.dart';
import 'package:medi_connect/modules/departments/customer_care/domain/usecases/get_customer_care_stats_usecase.dart';
...
import 'package:medi_connect/modules/departments/dyalisis/data/repository/dyalisis_repository_impl.dart';
import 'package:medi_connect/modules/departments/dyalisis/domain/usecases/get_dyalisis_stats_usecase.dart';
import 'package:medi_connect/modules/departments/dyalisis/presentation/bloc/dyalisis_bloc.dart';
import 'package:medi_connect/modules/departments/emrd/data/datasource/emrd_remote_datasource.dart';
import 'package:medi_connect/modules/departments/emrd/domain/repositories/emrd_repository.dart';
import 'package:medi_connect/modules/departments/emrd/data/repository/emrd_repository_impl.dart';
...
import 'package:medi_connect/modules/departments/finance/data/repository/finance_repository_impl.dart';
import 'package:medi_connect/modules/departments/finance/domain/usecases/get_finance_stats_usecase.dart';
import 'package:medi_connect/modules/departments/finance/presentation/bloc/finance_bloc.dart';
...
import 'package:medi_connect/modules/departments/fire_safety/data/repository/fire_safety_repository_impl.dart';
import 'package:medi_connect/modules/departments/fire_safety/domain/usecases/get_fire_safety_stats_usecase.dart';
import 'package:medi_connect/modules/departments/fire_safety/presentation/bloc/fire_safety_bloc.dart';
...
import 'package:medi_connect/modules/departments/general_store/data/repository/general_store_repository_impl.dart';
import 'package:medi_connect/modules/departments/general_store/domain/usecases/get_general_store_stats_usecase.dart';
import 'package:medi_connect/modules/departments/general_store/presentation/bloc/general_store_bloc.dart';
...
import 'package:medi_connect/modules/departments/human_resource/data/repository/human_resource_repository_impl.dart';
import 'package:medi_connect/modules/departments/human_resource/domain/usecases/get_human_resource_stats_usecase.dart';
import 'package:medi_connect/modules/departments/human_resource/presentation/bloc/human_resource_bloc.dart';
import 'package:medi_connect/modules/departments/icu/data/datasource/icu_remote_datasource.dart';
import 'package:medi_connect/modules/departments/icu/domain/repositories/icu_repository.dart';
import 'package:medi_connect/modules/departments/icu/data/repository/icu_repository_impl.dart';
import 'package:medi_connect/modules/departments/icu/domain/usecases/get_icu_stats_usecase.dart';
import 'package:medi_connect/modules/departments/icu/presentation/bloc/icu_bloc.dart';
...
import 'package:medi_connect/modules/departments/information_technology/data/repository/information_technology_repository_impl.dart';
import 'package:medi_connect/modules/departments/information_technology/domain/usecases/get_information_technology_stats_usecase.dart';
import 'package:medi_connect/modules/departments/information_technology/presentation/bloc/information_technology_bloc.dart';
import 'package:medi_connect/modules/departments/laboratory/data/datasource/laboratory_remote_datasource.dart';
import 'package:medi_connect/modules/departments/laboratory/domain/repositories/laboratory_repository.dart';
import 'package:medi_connect/modules/departments/laboratory/data/repository/laboratory_repository_impl.dart';
import 'package:medi_connect/modules/departments/laboratory/domain/usecases/get_laboratory_stats_usecase.dart';
import 'package:medi_connect/modules/departments/laboratory/presentation/bloc/laboratory_bloc.dart';
import 'package:medi_connect/modules/departments/management_information_system/data/datasource/management_information_system_remote_datasource.dart';
...
import 'package:medi_connect/modules/departments/management_information_system/data/repository/management_information_system_repository_impl.dart';
import 'package:medi_connect/modules/departments/management_information_system/domain/usecases/get_management_information_system_stats_usecase.dart';
import 'package:medi_connect/modules/departments/management_information_system/presentation/bloc/management_information_system_bloc.dart';
import 'package:medi_connect/modules/departments/marketing/data/datasource/marketing_remote_datasource.dart';
import 'package:medi_connect/modules/departments/marketing/domain/repositories/marketing_repository.dart';
import 'package:medi_connect/modules/departments/marketing/data/repository/marketing_repository_impl.dart';
import 'package:medi_connect/modules/departments/marketing/domain/usecases/get_marketing_stats_usecase.dart';
import 'package:medi_connect/modules/departments/marketing/presentation/bloc/marketing_bloc.dart';
...
import 'package:medi_connect/modules/departments/mep_engineer/data/repository/mep_engineer_repository_impl.dart';
import 'package:medi_connect/modules/departments/mep_engineer/domain/usecases/get_mep_engineer_stats_usecase.dart';
import 'package:medi_connect/modules/departments/mep_engineer/presentation/bloc/mep_engineer_bloc.dart';
...
import 'package:medi_connect/modules/departments/nursing/data/repository/nursing_repository_impl.dart';
import 'package:medi_connect/modules/departments/nursing/domain/usecases/get_nursing_stats_usecase.dart';
import 'package:medi_connect/modules/departments/nursing/presentation/bloc/nursing_bloc.dart';
...
import 'package:medi_connect/modules/departments/nutrition_and_diabetics/data/repository/nutrition_and_diabetics_repository_impl.dart';
import 'package:medi_connect/modules/departments/nutrition_and_diabetics/domain/usecases/get_nutrition_and_diabetics_stats_usecase.dart';
import 'package:medi_connect/modules/departments/nutrition_and_diabetics/presentation/bloc/nutrition_and_diabetics_bloc.dart';
...
import 'package:medi_connect/modules/departments/operation_theatre/data/repository/operation_theatre_repository_impl.dart';
import 'package:medi_connect/modules/departments/operation_theatre/domain/usecases/get_operation_theatre_stats_usecase.dart';
import 'package:medi_connect/modules/departments/operation_theatre/presentation/bloc/operation_theatre_bloc.dart';
import 'package:medi_connect/modules/departments/pharmacy/data/datasource/pharmacy_remote_datasource.dart';
import 'package:medi_connect/modules/departments/pharmacy/domain/repositories/pharmacy_repository.dart';
import 'package:medi_connect/modules/departments/pharmacy/data/repository/pharmacy_repository_impl.dart';
import 'package:medi_connect/modules/departments/pharmacy/domain/usecases/get_pharmacy_stats_usecase.dart';
...
import 'package:medi_connect/modules/departments/physio_therapy/data/repository/physio_therapy_repository_impl.dart';
import 'package:medi_connect/modules/departments/physio_therapy/domain/usecases/get_physio_therapy_stats_usecase.dart';
import 'package:medi_connect/modules/departments/physio_therapy/presentation/bloc/physio_therapy_bloc.dart';
import 'package:medi_connect/modules/departments/purchase/data/datasource/purchase_remote_datasource.dart';
import 'package:medi_connect/modules/departments/purchase/domain/repositories/purchase_repository.dart';
import 'package:medi_connect/modules/departments/purchase/data/repository/purchase_repository_impl.dart';
import 'package:medi_connect/modules/departments/purchase/domain/usecases/get_purchase_stats_usecase.dart';
import 'package:medi_connect/modules/departments/purchase/presentation/bloc/purchase_bloc.dart';
import 'package:medi_connect/modules/departments/radiology/data/datasource/radiology_remote_datasource.dart';
import 'package:medi_connect/modules/departments/radiology/domain/repositories/radiology_repository.dart';
import 'package:medi_connect/modules/departments/radiology/data/repository/radiology_repository_impl.dart';
import 'package:medi_connect/modules/departments/radiology/domain/usecases/get_radiology_stats_usecase.dart';
import 'package:medi_connect/modules/departments/radiology/presentation/bloc/radiology_bloc.dart';
...
import 'package:medi_connect/modules/departments/ward/data/repository/ward_repository_impl.dart';
import 'package:medi_connect/modules/departments/ward/domain/usecases/get_ward_stats_usecase.dart';
import 'package:medi_connect/modules/departments/ward/presentation/bloc/ward_bloc.dart';
