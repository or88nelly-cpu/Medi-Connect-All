...
class AppStrings {
  ...
  static const onboardingDesc1 = "Connect with certified medical specialists instantly.";
  static const onboardingTitle2 = "Book Appointments easily";
  static const onboardingDesc2 = "Schedule physical or video consultation bookings anytime.";
  static const onboardingTitle3 = "Secure Medical Records";
  static const onboardingDesc3 = "Store and access reports, tests, and advice securely.";
  ...
  static const registerSubtitle = "Join the platform and manage your healthcare journey.";
  ...
  static const forgotPasswordDesc = "Enter your email to receive a password reset OTP/link.";
  ...
  static const otpVerificationDesc = "Enter the 6-digit verification code sent to your phone/email.";
  ...
  static const publicWebsiteTitle = "Welcome to Medi-Connect Public Website Portal";
  ...
  static const appointmentsModuleDesc = "Access your appointments settings and records";
  static const chatModuleDesc = "Access your chat settings and records";
  static const medicalRecordsModuleDesc = "Access your medical records settings and records";
  ...
  static const videoConsultationModuleDesc = "Access your video consultation settings and records";
  static const dietPlansModuleDesc = "Access your diet plans settings and records";
  static const exercisePlansModuleDesc = "Access your exercise plans settings and records";
  static const notificationsModuleDesc = "Access your notifications settings and records";
  ...
  static const adminPortalDesc = "Platform configuration, logs, and security compliance";
  static const accessAdminPortal = "Access Admin Portal";
  static const patientPortalTitle = "Patient Portal";
  static const patientPortalDesc = "Manage your personal appointments and records";
  static const accessPatientPortal = "Access Patient Portal";
  static const doctorPortalTitle = "Doctor Portal";
  static const doctorPortalDesc = "Manage your schedule, appointments, and consultations";
  static const accessDoctorPortal = "Access Doctor Portal";
  static const staffPortalTitle = "Staff Portal";
  static const staffPortalDesc = "Manage clinic administration, details, and schedules";
  static const accessStaffPortal = "Access Staff Portal";
  static const selectPortalAccess = "Select Portal Access";
  static const selectPortalAccessSubtitle = "Select a portal access point below";
  static const backToOnboarding = "Back to Onboarding";
  static const loginAs = "Login as ";
  static const enterCredentialsToEnter = "Enter your credentials to enter the panel.";
  ...
  static const patientAccessProfileDesc = "Access your Medi-Connect patient profile.";
  static const doctorAccessProfileDesc = "Access your Medi-Connect doctor profile.";
  static const staffAccessProfileDesc = "Access your Medi-Connect staff profile.";
  ...
  static const doctorProfessionalRegistration = "Doctor Professional Registration";
  static const medicalStaffRegistration = "Medical Staff Registration";
  static const adminProfileSetup = "Admin Profile Setup";
  static const patientProfileOnboardingDesc = "Please provide details to complete your healthcare profile.";
  static const doctorProfessionalRegistrationDesc = "Enter your department, qualification, and specialty to verify.";
  static const medicalStaffRegistrationDesc = "Please specify your department and work shift details.";
  static const adminProfileSetupDesc = "Complete your administrative account details.";
  ...
  static const professionalQualifications = "Professional Qualifications (e.g. MD, MBBS)";
  ...
  static const doctorsDirectoryDesc = "Manage doctors listings, scheduling, and leaves.";
  static const staffDirectory = "Staff Directory";
  static const staffDirectoryDesc = "Roster staff, shifts, and check attendance logs.";
  static const patientsDirectory = "Patients Directory";
  static const patientsDirectoryDesc = "Access patient profiles and family members.";
